...
public class CurlTest {
  ...
  public void testStandard() {
    ...
    String expected = "There was once a king who had an illness, and no one "
        ...
        + "find.\"\n"
        + "The eldest said, \"I will manage to find it.\" And went to "
        + "the sick\n"
        + "king, and begged to be allowed to go forth in search of the"
        + " water of\n"
        + "life, for that alone could save him.  \"No,\" said the king,"
        ...
        + " shrimp,\"\n"
        + "said the prince, very haughtily, \"it is nothing to do with"
        + " you.\" And\n"
        ...
        + "kingdom will fall to me.\" At first the king would not allow"
        + " him to go\n"
        ...
        + "shrimp,\" said the prince, \"that is nothing to do with "
        + "you.\" And rode\n"
        + "on without giving him another look.  But the dwarf bewitched"
        + " him, and\n"
        ...
        + "obliged to let him go.  When he met the dwarf and the latter"
        + " asked\n"
        ...
        + " like your\n"
        + "false brothers, I will give you the information and tell you"
        + " how you\n"
        + "may obtain the water of life.  It springs from a fountain in the\n"
        + "courtyard of an enchanted castle, but you will not be able to"
        + " make\n"
        + "your way to it, if I do not give you an iron wand and two small\n"
        + "loaves of bread.  Strike thrice with the wand on the iron door"
        + " of the\n"
        ...
        + " he had\n"
        + "appeased the lions with the bread, he entered the castle,"
        + " and came to\n"
        ...
        + "stood\n"
        + "near, and hastened away.  But just as he was passing through "
        + "the iron\n"
        ...
        + "homewards, and again passed the dwarf.  When the latter saw"
        + " the sword\n"
        + "and the loaf, he said, \"With these you have won great wealth,"
        + " with\n"
        + "the sword you can slay whole armies, and the bread will never "
        + "come to\n"
        ...
        + " the\n"
        + "prince begged until the dwarf released them, but he warned him"
        + " and\n"
        + "said, \"Beware of them, for they have bad hearts.\" When his"
        + " brothers\n"
        + "came, he rejoiced, and told them how things had gone with him,"
        + " that\n"
        + "he had found the water of life and had brought a cupful away"
        + " with\n"
        ...
        + "hosts of his enemies, and could now live in rest and peace."
        + "  The\n"
        + "prince then took back his loaf and his sword, and the three"
        + " brothers\n"
        + "rode on.  But after this they entered two more countries"
        + " where war\n"
        + "and famine reigned and each time the prince gave his loaf and"
        + " his\n"
        ...
        + "him\n"
        + "the kingdom - the kingdom which belongs to us, and he will rob"
        + " us of\n"
        + "all our fortune.\" They then began to seek revenge, and plotted "
        + "with\n"
        + "each other to destroy him.  They waited until they found him "
        + "fast\n"
        ...
        + " cured.\n"
        + "But scarcely had he drunk a very little of the salt sea-water "
        + "than he\n"
        + "became still worse than before.  And as he was lamenting "
        + "over this,\n"
        + "the two eldest brothers came, and accused the youngest of having\n"
        + "intended to poison him, and said that they had brought him"
        + " the true\n"
        + "water of life, and handed it to him.  He had scarcely tasted "
        + "it, when\n"
        + "he felt his sickness departing, and became strong and healthy"
        + " as in\n"
        + "the days of his youth.\n" + "\n"
        + "After that they both went to the youngest, mocked him, and"
        + " said, \"You\n"
        + "certainly found the water of life, but you have had the pain,"
        + " and we\n"
        + "the gain, you should have been cleverer, and should have kept "
        + "your\n"
        + "eyes open.  We took it from you whilst you were asleep at sea,"
        + " and\n"
        + "when a year is over, one of us will go and fetch the beautiful\n"
        + "princess. But beware that you do not disclose aught of this"
        + " to our\n"
        ...
        + " had\n"
        + "plotted against his life.  So he summoned the court together"
        + " and had\n"
        + "sentence pronounced upon his son, that he should be secretly "
        + "shot.\n"
        + "And once when the prince was riding forth to the chase, suspecting"
        + " no\n"
        + "evil, the king's huntsman was told to go with him, and when "
        + "they were\n"
        + "quite alone in the forest, the huntsman looked so sorrowful "
        + "that the\n"
        + "prince said to him, \"Dear huntsman, what ails you?\" The"
        + " huntsman\n"
        + "said, \"I cannot tell you, and yet I ought.\" Then the prince"
        + " said,\n"
        + "\"Say openly what it is, I will pardon you.\" \"Alas,\" said"
        + " the\n"
        + "huntsman, \"I am to shoot you dead, the king has ordered me to"
        + " do it.\"\n"
        + "Then the prince was shocked, and said, \"Dear huntsman, let me"
        + " live,\n"
        + "there, I give you my royal garments, give me your common ones in\n"
        + "their stead.\" The huntsman said, \"I will willingly do that,"
        + " indeed I\n"
        ...
        + " to the\n"
        + "king for his youngest son, which were sent by the three kings"
        + " who had\n"
        + "slain their enemies with the prince's sword, and maintained their\n"
        + "people with his bread, and who wished to show their gratitude"
        + " for it.\n"
        + "The old king then thought, \"Can my son have been innocent?\" "
        + "And said\n"
        + "to his people, \"Would that he were still alive, how it "
        + "grieves me\n"
        + "that I have suffered him to be killed.\" \"He still lives,\" said"
        + " the\n"
        + "huntsman, \"I could not find it in my heart to carry out your\n"
        + "command.\" And told the king how it had happened.  Then a"
        + " stone fell\n"
        + "from the king's heart, and he had it proclaimed in every"
        + " country that\n"
        + "his son might return and be taken into favor again.\n" + "\n"
        + "The princess, however, had a road made up to her palace which"
        + " was\n"
        + "quite bright and golden, and told her people that whosoever"
        + " came\n"
        + "riding straight along it to her, would be the right one and"
        + " was to be\n"
        + "admitted, and whoever rode by the side of it, was not the "
        + "right one\n"
        + "and was not to be admitted.\n" + "\n"
        + "As the time was now close at hand, the eldest thought he"
        + " would hasten\n"
        + "to go to the king's daughter, and give himself out as her"
        + " rescuer,\n"
        ...
        + " the\n"
        + "golden road, and his horse had put one foot on it, he thought,"
        + " it\n" + "would be a sin and a shame, a piece might be trodden off."
        + "  And he\n"
        + "turned aside and rode on the left side of it, and when he "
        + "reached the\n"
        ...
        + " forget\n"
        + "his sorrows.  So he set out and thought of her so incessantly,"
        + " and\n"
        ...
        + " he\n"
        + "came to the door, it was opened and the princess received him"
        + " with\n"
        + "joy, and said he was her saviour, and lord of the kingdom, and"
        + " their\n"
        + "wedding was celebrated with great rejoicing.  When it was over"
        + " she\n"
